defmodule AshSwarm.Test.Mocks do
  ...
  Mox.defmock(AshSwarm.MockAIAdaptationStrategies,
    for: AshSwarm.Test.MockAIAdaptationStrategies.Behaviour
  )

  Mox.defmock(AshSwarm.MockAIExperimentEvaluation,
    for: AshSwarm.Test.MockAIExperimentEvaluation.Behaviour
  )
end
...
defmodule AshSwarm.Test.MockImplementations do
  ...
  def setup_mock_adaptation_strategies do
    Mox.stub(AshSwarm.MockAIAdaptationStrategies, :generate_optimized_implementation, fn _code,
                                                                                         _usage_data,
                                                                                         _options ->
      {:ok,
       %{
  ...
  def setup_mock_experiment_evaluation do
    Mox.stub(AshSwarm.MockAIExperimentEvaluation, :evaluate_experiment, fn _original_code,
                                                                           _adapted_code,
                                                                           _metrics,
                                                                           _options ->
      {:ok,
