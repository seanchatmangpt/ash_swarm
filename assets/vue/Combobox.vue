...
<template>
  <ComboboxRoot class="relative">
    <ComboboxAnchor
      ...
      <ComboboxInput class="!bg-transparent outline-none text-grass11 h-full selection:bg-grass5 placeholder-stone-400"
      ...
      <ComboboxViewport class="p-[5px]">
        ...
        <template v-for="(group, index) in options" :key="group.name">
          <ComboboxGroup>
            ...
            <ComboboxItem v-for="option in group.children" :key="option.name" :value="option.name"
